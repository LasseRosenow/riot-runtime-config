...
static void tests_registry_all_min_values(void)
{
    ...
    const char *ouput_string = registry_get_string(path, NULL);
    ...
    const bool *output_bool = registry_get_bool(path);
    ...
    const uint8_t *output_u8 = registry_get_uint8(path);
    ...
    const uint16_t *output_u16 = registry_get_uint16(path);
    ...
    const uint32_t *output_u32 = registry_get_uint32(path);
    ...
    const uint64_t *output_u64 = registry_get_uint64(path);
    ...
    const int8_t *output_i8 = registry_get_int8(path);
    ...
    const int16_t *output_i16 = registry_get_int16(path);
    ...
    const int32_t *output_i32 = registry_get_int32(path);
    ...
    const int64_t *output_i64 = registry_get_int64(path);
