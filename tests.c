...
static void _registry_set_and_get(int *path, int path_len, char *input, char *output_buf,
                                  int output_buf_len)
{
...
static void tests_registry_all_min_values(void)
{
    ...
    _registry_set_and_get(path_string, ARRAY_SIZE(path_string), "", output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING("", output_buf);

    // bool
    int path_bool[] = { registry_schema_test.id, 0, REGISTRY_SCHEMA_TEST_BOOL };

    _registry_set_and_get(path_bool, ARRAY_SIZE(path_bool), "0", output_buf,
                          ARRAY_SIZE(output_buf));
    ...
    _registry_set_and_get(path_i8, ARRAY_SIZE(path_i8), input_buf, output_buf, ARRAY_SIZE(
                              output_buf));
    ...
    _registry_set_and_get(path_i16, ARRAY_SIZE(path_i16), input_buf, output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
    ...
    _registry_set_and_get(path_i32, ARRAY_SIZE(path_i32), input_buf, output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
    ...
    _registry_set_and_get(path_i64, ARRAY_SIZE(path_i64), input_buf, output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
#endif /* CONFIG_REGISTRY_USE_INT64 */
    ...
    _registry_set_and_get(path_f32, ARRAY_SIZE(path_f32), input_buf, output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
#endif /* CONFIG_REGISTRY_USE_FLOAT32 */
    ...
    if (REGISTRY_MAX_VAL_LEN >= (DBL_MAX_10_EXP + 1) + 1 + 1 + 6) { // (DBL_MAX_10_EXP + 1) + sign + dot + 6 decimal places
        ...
        _registry_set_and_get(path_f64, ARRAY_SIZE(path_f64), input_buf, output_buf,
                              ARRAY_SIZE(output_buf));
        TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
    }
#endif /* CONFIG_REGISTRY_USE_FLOAT64 */
...
static void tests_registry_all_max_values(void)
{
    ...
    _registry_set_and_get(path_string, ARRAY_SIZE(path_string), input_buf, output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
    ...
    _registry_set_and_get(path_bool, ARRAY_SIZE(path_bool), "1", output_buf,
                          ARRAY_SIZE(output_buf));
    ...
    _registry_set_and_get(path_u8, ARRAY_SIZE(path_u8), input_buf, output_buf, ARRAY_SIZE(
                              output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
    ...
    _registry_set_and_get(path_u16, ARRAY_SIZE(path_u16), input_buf, output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
    ...
    _registry_set_and_get(path_u32, ARRAY_SIZE(path_u32), input_buf, output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
    ...
    _registry_set_and_get(path_u64, ARRAY_SIZE(path_u64), input_buf, output_buf,
                          ARRAY_SIZE(output_buf));
    TEST_ASSERT_EQUAL_STRING(input_buf, output_buf);
#endif /* CONFIG_REGISTRY_USE_UINT64 */
